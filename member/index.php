...
<html>
	...
	<body>
		...
		<center><legend>Member Login</legend></center>
			...
			<p align="center" style="font-size: 1.8rem;">Don't have an account?&nbsp;<a href="register.php" style="text-decoration:none; color:red;">Register Now!</a>
	...
	<?php
		if(isset($_POST['m_login']))
		{
			...
			$query->bind_param("ss", $_POST['m_user'], $m_pass);
			$query->execute();
